...
export const FacebookIcon = ({ className, ...props }) => (
  ...
  >
    <g clipPath="url(#a)">
      <path
        fill="#3C5A99"
        d="M23.471 24.834c.753 0 1.363-.61 1.363-1.363V1.502c0-.754-.61-1.364-1.363-1.364H1.502C.746.137.136.747.136 1.5v21.971c0 .753.61 1.363 1.363 1.363h21.971Z"
      />
      <path
        fill="#fff"
        d="M14.11 22.97v-9.565h3.21l.48-3.727h-3.69v-2.38c0-1.079.3-1.814 1.847-1.814h1.973V2.148c-.34-.045-1.512-.147-2.876-.147-2.845 0-4.794 1.737-4.794 4.927v2.75H7.042v3.726h3.218v9.565h3.85Z"
      />
    </g>
    <defs>
      <clipPath id="a">
...
export const StackOverFlowIcon = ({ className, ...rest }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120"  {...rest}>
    <path
...
export const CircularText = ({ className, ...rest }) => (
  <svg
    ...
    {...rest}
  >
    <path d="M1069.003 1081H1V1.002L1080.997 1l.001 1079.998-11.996.001z" />
  </svg>
);
