    ...
    return(
        <div className='fixed left-4 bottom-4 flex items-center justify-center overflow-hidden'>
            <div className='w-48 h-auto flex items-center justify-center relative'>
                <Image src={hireMe} alt='hire me' className='fill-dark animate-spin-slow'/>
                <Link href={"mailto:jaydipramani23110@gmail.com"} className='flex items-center justify-center absolute left-1/2 top-1/2
