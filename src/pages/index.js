        ...
        <Layout className='pt-0'>
          <div className='flex items-center text-dark w-full min-h-screen'>
            ...
            <div className='w-1/2 flex flex-col items-center self-center'>
              ...
              As a skilled mobile app developer, I am dedicated to turning ideas into innovative applications. 
Explore my latest projects and articles, showcasing my expertise in App development.
              </p>
              <div className='flex items-center self-start mt-2'>
                <Link href="/Jaydip Ramani Resume.pdf" target={'_blank'}
                ...
                <Link href="mailto:jaydipramani23110@gmail.com" target={'_blank'} 
          ...
          <div className='absolute right-8 bottom-8 inline-block w-24'>
            <Image src={lightbulb} alt="Jd&apos;s Thoughts" className='w-full h-auto'/>
          </div>
      </main>
    </>
  )
